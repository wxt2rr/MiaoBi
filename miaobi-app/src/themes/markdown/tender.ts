...
#nice h3 .content {
  border-bottom: 2px solid #7BBFEA;
  color: #595959;
}
...
#nice .footnotes-sep:before {
  ...
  border-bottom: 2px solid #7BBFEA;
  display: inline;
  background: linear-gradient(white 60%, #E8F4FD 40%);
  font-size: 20px;
}
